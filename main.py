...
def main():
    ...
    inject_local_font(os.path.join(os.getcwd(), 'static', 'source-sans.otf'), 'SourceSans3')
    ...
    with st.sidebar:
        ...
        if st.session_state.username:
            ...
            if not workout_started:
                ...
                plan_sets = st.number_input(f"Sets", min_value=0, max_value=50, key='plan_sets', step=1)
                plan_reps = st.number_input(f"Reps per Set", min_value=0, max_value=50, key='plan_reps')
